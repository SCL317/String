...
public class Test {
	...
	public void init() {
		ctx= new ClassPathXmlApplicationContext("spring_dao.xml");
	...
	public List<Users> getUsersList(Users users) {
		...
		List<Users> usersList=this.jdbcTemplate.query(sql, new Object[]{users.getName(),users.getPass()}, new BeanPropertyRowMapper<Users>(Users.class));
	    return usersList;
	}
...
//		users.setId(3L);
		users.setName("lisisi");
		users.setPass("666999");
...
//		logger.info(test.getCount("zhangsan"));List<Users> usersList =test.getUsersList(users);
